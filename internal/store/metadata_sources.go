...
var MetadataImplementations = []MetadataImplementation{
	...
	{Key: "discogs", Name: "Discogs", MediaTypes: []string{"music"},
		Supplies: "Cover art for albums whose folder has none, and the detail of a particular pressing",
		Help:     "Optional. A personal access token from discogs.com (Settings → Developers) raises the rate limit from 25 to 60 requests a minute; without one it still works, slower."},
